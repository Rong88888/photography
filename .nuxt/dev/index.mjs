...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:/Work/999-demo/Ai生成/Photography/photography/.data/kv"}));
...
const rootDir = "E:/Work/999-demo/Ai生成/Photography/photography";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"全场景摄影分享与垂直交流生态平台，提供作品展示、摄影教程、商业对接等服务"},{"property":"og:title","content":"影集社 - 摄影分享与交流平台"},{"property":"og:description","content":"全场景摄影分享与垂直交流生态平台，优质摄影作品、教程、商业对接一站式服务。"},{"property":"og:type","content":"website"},{"property":"og:url","content":"https://your-domain.com"},{"property":"og:image","content":"https://your-domain.com/og-image.jpg"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:title","content":"影集社 - 摄影分享与交流平台"},{"name":"twitter:description","content":"全场景摄影分享与垂直交流生态平台，优质摄影作品、教程、商业对接一站式服务。"},{"name":"twitter:image","content":"https://your-domain.com/og-image.jpg"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"影集社 - 摄影分享与交流平台"};
...
const _q2stHOyrjI6Ebrgp2sZjwCvTMIVW5er4P5GUTpZ6y1w = (nitroApp) => {
...
_q2stHOyrjI6Ebrgp2sZjwCvTMIVW5er4P5GUTpZ6y1w
];
...
const getClientManifest = () => import('file://E:/Work/999-demo/Ai%E7%94%9F%E6%88%90/Photography/photography/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_haeL53 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _yJ8xDh, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_haeL53, lazy: true, middleware: false, method: undefined },
